...
// LLC
  ...
  CACHE *LLC = new REUSE_CACHE_LLC{"LLC", REUSE_CACHE_TAG_ARRAY_WAYS, REUSE_CACHE_TAG_ARRAY_SET, REUSE_CACHE_DATA_ARRAY_WAYS, REUSE_CACHE_DATA_ARRAY_SET, LLC_WQ_SIZE, LLC_RQ_SIZE, LLC_PQ_SIZE, LLC_MSHR_SIZE};
#else
